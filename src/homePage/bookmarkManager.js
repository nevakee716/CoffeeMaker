...
(function (cwApi) {
    ...
    cwApi.CwBookmarkManager = (function () {
        var cwUserFavourites = {},
            commentData = {},
            getTotalComment, cleanVariables, getViewedComment, setComment, loadFavourites, getCurrentUserFavorites, getFavouriteList, outputFavourites, saveUserFavorites,manageFavImage, outputFavoritesDom, getUnreadComment, markAsReadClick, updateUnreadCommentFromVariable, getCurrentItemInVariable, updateViewedComment;
		...
		manageFavImage = function(l,output) {
    		...
    		if (config.lastModifiedObjectFav) {
        ...
        markAsReadClick = function (totalComment, mainObject, discussionObject) {
            var objectTypeScriptName, objectId, queryString = cwApi.getQueryStringObject();
